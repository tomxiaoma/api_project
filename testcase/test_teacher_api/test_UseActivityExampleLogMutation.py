...
"""
import allure
from params.teacher_param_read_yaml import UseActivityExampleLogMutation
...
class TestUseActivityExampleLogMutation:

    @allure.title("园时光描述范例库选用log")
    def test_use_activity_exampleLog_mutation(self):
