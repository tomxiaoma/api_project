"""
author:xiaoma
datetime:2019/12/16 11:59
describe:

"""
import allure
from params.teacher_param_read_yaml import StudentEvaluationQuery
...
class TestStudentEvaluationQuery:

    @allure.title("根据评价ID以及学生ID查询评估信息")
    def test_student_evaluation_query(self):
        log.info("根据评价ID以及学生ID查询评估信息")
        conf = Config()
        data = StudentEvaluationQuery().yaml_data
